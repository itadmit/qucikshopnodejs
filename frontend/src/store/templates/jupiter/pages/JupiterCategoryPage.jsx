  ...
  const fetchCategoryData = async () => {
    try {
      ...
      const [categoryResponse, productsResponse] = await Promise.all([
                  fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:3001/api'}/stores/${storeData.slug}/categories/${slug}`),
          fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:3001/api'}/stores/${storeData.slug}/categories/${slug}/products`)
      ])
